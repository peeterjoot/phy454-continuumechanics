...
argues that since the velocities are tangential to any streamline, and because \( \Bu \cross \lr{ \spacegrad \cross \Bu } \) is perpendicular to \( \Bu \), the projection of that curl term on the streamline direction is zero.  That leaves a zero for the projection of the gradient along the streamline direction
%
