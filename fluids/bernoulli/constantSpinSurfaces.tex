...
%
\makeoproblem{Surface for spinning bucket.}{problem:fluids:constantSpinSurfaces}
{2009 phy1530 final}
{
...
\begin{aligned}
2 \Omega^2
&= (\partial_x + \partial_y) \lr{ \inv{2} \Bu^2 + \frac{p}{\rho} + g z } \\
&= (\partial_x + \partial_y) \lr{ \inv{2} \Bu^2 + \frac{p}{\rho} }.
\end{aligned}
\end{equation}
%
...
\begin{aligned}
0
&= \Bu \cdot \spacegrad \lr{ \inv{2} \Bu^2 + \frac{p}{\rho} + g z } \\
&= \Omega ( y \partial_x - x \partial_y ) \lr{ \inv{2} \Bu^2 + \frac{p}{\rho} }.
\end{aligned}
\end{equation}
%
...
%
%
\begin{equation}\label{eqn:constantSpinSurfaces:251}
\begin{aligned}
x &= \rho \cos\theta \\
y &= \rho \sin\theta.
\end{aligned}
...
%
\begin{equation}\label{eqn:constantSpinSurfaces:252}
...
\end{equation}
%
Integrating these, we seek simultaneous solutions to
%
