...
%
\imageFigure{../figures/phy454-continuumechanics/tapFlowMeasurementCropped6cmFig3}{Tap flow measurement.}{fig:tapFlowCropped6cm:tapFlowCropped6cmFig3}{0.25}
%
...
In \cref{fig:tapFlowCropped6cm:tapFlowCropped6cmFig4} is a plot of the measured radial distance compared to what was computed with \cref{eqn:continuumFluidsReview:1990}.  The blue line is the measured width of the stream as measured, the red is a polynomial curve fitted to the raw data, and the green is the computed curve above.
%
\imageFigure{../figures/phy454-continuumechanics/tapFlowComparison_of_measured_stream_radii_and_calculatedCropped6cmFig4}{Comparison of measured stream radii and calculated.}{fig:tapFlowCropped6cm:tapFlowCropped6cmFig4}{0.25}
} % end answer
