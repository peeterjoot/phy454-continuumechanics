...
\end{equation}
%
Now we have to fix the sign.  I did not recall any sort of notion of a signed radius of curvature, but there is a blurb about it on the curvature article above, including a nice illustration of signed radius of curvatures can be found in \citep{wiki:LemniscateCurvatureFigure}.
%this \href{https://goo.gl/Wqzz2}{wikipedia radius of curvature figure for a Lemniscate}.
