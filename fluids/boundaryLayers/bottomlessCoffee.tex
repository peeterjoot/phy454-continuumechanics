...
\imageFigure{../figures/phy454-continuumechanics/bw/bottomlessCoffeeFig16}{Bessel \(J_1( \lambda_i z)\) zero crossings.}{fig:bottomlessCoffee:bottomlessCoffeeFig3}{0.2}
...
\imageFigure{../figures/phy454-continuumechanics/bw/bottomlessCoffeeFig17}{Bessel function fitting for the steady state velocity profile for \(n = 1, 3, 5\).}{fig:bottomlessCoffee:bottomlessCoffeeFig2}{0.2}
%
