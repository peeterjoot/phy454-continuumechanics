...
%
\imageFigure{../figures/phy454-continuumechanics/lec18_Flow_over_a_solid_object_with_boundary_layerFig1}{Flow over object with boundary layer.}{fig:continuumL18:continuumL18Fig1}{0.2}
%
...
\end{subequations}
%
Let us look at the scaling of these equations, starting with the continuity equation \cref{eqn:continuumL18:70}.  This is roughly
%
...
\end{equation}
%
So we can neglect the \(x\) component of the Laplacian in our \(x\) momentum equation \cref{eqn:continuumL18:30}.
...
\end{subequations}
%
Utilizing Bernoulli's theorem \cref{eqn:continuumL18:410}, we can deal with the pressure term, the magnitude of which is
%
...
Observe that if we operate on \cref{eqn:continuumL18:370} with a divergence operation, then we do not have to assume non-viscous flow but in that case we can only say that (for irrotational flow) we have
%
