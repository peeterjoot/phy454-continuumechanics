...
\end{equation}
%
Using this, and \cref{eqn:continuumL22:110}, and neglecting any terms of second order smallness we have
%
\boxedEquation{eqn:continuumL22:230}{
\PD{t}{\delta T} + \delta \Bu \cdot \spacegrad T_s = \kappa \spacegrad^2 \delta T.
}
%
We would like to solve this and \cref{eqn:continuumL22:170} simultaneously.
...
Let us apply this rescaling to our perturbed velocity \cref{eqn:continuumL22:170}
%
...
\end{equation*}
%
but performing this non-dimensionalization shows that this was either quoted incorrectly, or typed wrong in the heat of the moment.  A check against the text shows (equation (9.27)), shows that \cref{eqn:continuumL22:330} is correct.
%
\section{Non-dimensionalization of the energy equation.}
%
Rescaling our energy \cref{eqn:continuumL22:230} we find
%
...
We have got a pair of nasty looking coupled equations \cref{eqn:continuumL22:310b}, and \cref{eqn:continuumL22:350}.  Repeated so that we can see them together
%
\begin{subequations}
...
\end{subequations}
%
it is clear that we can decouple these by inserting \cref{eqn:continuumL22:670} into \cref{eqn:continuumL22:650}.  Doing that gives us a beastly 6th order spatial equation for the perturbed temperature
%
...
\end{equation}
%
For \cref{eqn:continuumL22:730} to be separable we require a constant proportionality
%
...
\end{equation}
and \( \phi = i ( k_1 x + k_2 y) + \sigma t \), the beastly equation to solve is
...
\end{equation}
%
Let us back up a bit instead.  Looking back to \cref{eqn:continuumL22:670}, it is clear that we will have the same separable form for our perturbed velocity since we have
...
\end{subequations}
%
Considering the boundary conditions, if the heating is even then at \(z = t = 0\) we can not have any variation with \(x\) and \(y\), so can only have \(\Theta(0) = 0\).  Thus at the boundary, from \cref{eqn:continuumL22:990}, we have
...
\end{equation}
%
Expanding out \cref{eqn:continuumL22:1030} then gives us
...
\end{equation}
%
These boundary value constraints \cref{eqn:continuumL22:1050}, and \cref{eqn:continuumL22:1070b}, plus the coupled system equations \cref{eqn:continuumL22:990a} are the complete problem to solve.  To get a feel for the solution of this system, consider the system with the following simpler set of boundary value constraints
...
\sin\left( n \pi z \right).
\end{equation}
Inserting \cref{eqn:continuumL22:470} into our system \cref{eqn:continuumL22:990a}, we have
\begin{equation}\label{eqn:continuumL22:1110}
\begin{aligned}
0 &=
\left( -\left( n \pi \right)^2 - k^2 \right)
\left( 
   \sigma - \left( -\left( n \pi \right)^2 - k^2 \right)
\right) A_n
\sin\left( n \pi z \right) \\
&\quad + \calR k^2 B_n
\sin\left( n \pi z \right)
