...
so the force per unit length that the lower interface boundary applies to the fluid is
\begin{equation}\label{eqn:continuumFluidsReview:1430}
L \left( G h - \frac{v \mu}{2 h} \right),
\end{equation}
and the force per unit length that the upper interface boundary applies to the fluid is
\begin{equation}\label{eqn:continuumFluidsReview:1431}
L \left( -G h + \frac{v \mu}{2 h} \right).
\end{equation}
