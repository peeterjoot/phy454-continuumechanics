...
Note that unlike our momentum conservation equation in elasticity \cref{eqn:continuumElasticityReview:570}, we have a first order time derivative on the LHS.  This is because \(u_i\) is taken to be a velocity here, but was a position displacement in the elasticity review.
...
In addition the constraints provided by the no-slip condition, we will often have to constrain our solutions according to the equality of the tangential components of the traction vector
%
