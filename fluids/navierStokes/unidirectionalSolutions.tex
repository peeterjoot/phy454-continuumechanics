...
%
\imageFigure{../figures/phy454-continuumechanics/lec11_Rocking_tank_velocity_matchingFig1}{Rocking tank velocity matching.}{fig:continuumL11:continuumL11fig1}{0.2}
%
...
%
\imageFigure{../figures/phy454-continuumechanics/lec11_Normals_and_tangents_at_interface_for_2D_systemFig2}{Normals and tangents at interface for 2D system.}{fig:continuumL11:continuumL11fig2}{0.15}
%
...
\end{equation}
%
\makeexample{Steady incompressible flow.}
%{Steady incompressible rectilinear (unidirectional) flow}
{ex:fluids:rectilinear}{
For steady incompressible rectilinear (unidirectional) flow, 
we can fix our axis so that
...
\end{aligned}
\end{equation}
With incompressibility and \(u = v = 0\) conditions killing this term, and the steady state condition \cref{eqn:continuumL11:210} killing the \(\rho \PDi{t}{\Bu}\) term, the Navier-Stokes equation for this incompressible unidirectional steady state flow (in the absence of body forces) is reduced to
...
\imageFigure{../figures/phy454-continuumechanics/lec11_Pressure_gradient_in_1D_systemFig3}{Pressure gradient in 1D system.}{fig:continuumL11:continuumL11fig3}{0.15}
The pressure is
...
%
\imageFigure{../figures/phy454-continuumechanics/lec11_Velocity_variation_with_height_in_shearing_flowFig4}{Velocity variation with height in shearing flow.}{fig:continuumL11:continuumL11fig4}{0.15}
%
...
\end{equation}
%
For such a flow \cref{eqn:continuumL11:330a} simplifies to
%
...
\end{equation}
%
This time our simplified Navier-Stokes equation \cref{eqn:continuumL11:330a} is reduced to something slightly more complicated
%
...
%
\imageFigure{../figures/phy454-continuumechanics/lec11_1D_Channel_flow_coordinate_system_setupFig5}{1D Channel flow coordinate system setup.}{fig:continuumL11:continuumL11fig5}{0.15}
%
...
%
\imageFigure{../figures/phy454-continuumechanics/lec11_Parabolic_velocity_distributionFig6}{Parabolic velocity distribution.}{fig:continuumL11:continuumL11fig6}{0.15}
%
...
%
\imageFigure{../figures/phy454-continuumechanics/lec11_Normals_in_1D_channel_flow_systemFig7}{Normals in 1D channel flow system.}{fig:continuumL11:continuumL11fig7}{0.15}
%
...
\end{equation}
%
Here the \(x\) directionality comes from the \(i = 1\) index of the stress tensor, so the force per unit distance is
%
