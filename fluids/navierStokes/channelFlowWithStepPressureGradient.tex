...
%
%
\makeoproblem{Channel flow, step pressure.}
...
\end{subequations}
%
Substitution of \cref{eqn:channelFlowWithStepPressureGradient:50} into \cref{eqn:channelFlowWithStepPressureGradient:30} gives us
...
The boundary value conditions \(u(\pm h, t) = 0\), and implied by the no-slip constraint.
%
For \(t \ge 0\) we have
...
\end{equation}
%
But from \cref{eqn:channelFlowWithStepPressureGradient:170}, we see that all we have left is a homogeneous problem in \(u_H\)
...
\end{equation}
%
Our undetermined constants should be provided by the boundary value constraint at \(t = 0\) \cref{eqn:channelFlowWithStepPressureGradient:310}, leaving us to solve the Fourier problem
