...
&= -\frac{2 \pi R_1^2 \Delta z \mu}{R_2^2 - R_1^2} \lr{ R_2^2 \Omega_2 - R_1^2 \Omega_1 +\frac{R_1^2 R_2^2}{R_1^2} (\Omega_2 -\Omega_1) } \\
&= \frac{2 \pi R_1^2 \Delta z \mu}{R_2^2 - R_1^2} \lr{ -2 R_2^2 \Omega_2 + (R_1^2 + R_2^2) \Omega_1 }.
\end{aligned}
\end{equation}
%
