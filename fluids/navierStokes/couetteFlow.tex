...
%
\imageFigure{../figures/phy454-continuumechanics/couetteFlowFig1}{Couette flow configuration.}{fig:couetteFlow:couetteFlowFig1}{0.2}
%
...
\end{equation}
%
Let us first verify that the incompressible condition \cref{eqn:couetteFlow:90} is satisfied for the presumed form of the solution we seek.  We have
%
...
\end{equation}
%
Good.  Now let us write out the terms of the momentum conservation equation \cref{eqn:couetteFlow:70}.  We have got
%
...
\end{equation}
%
for which we have been told to expect that \cref{eqn:couetteFlow:50} is a solution (and it has the two integration constants we require for a solution to a homogeneous equation of this form).  Let us verify that we have computed the correct differential equation for the problem by trying this solution
%
...
\begin{aligned}
p(r) -p_0
&= \frac{\rho }{(R_2^2 - R_1^2)^2} 
\Biglr{
  \inv{2}
  \lr{ R_2^2 \Omega_2 - R_1^2 \Omega_1 }^2
  r^2 
  -\frac{R_1^4 R_2^4}{2 r^2} (\Omega_1  - \Omega_2)^2 \\
  &\qquad 
  + 2 \lr{ R_2^2 \Omega_2 - R_1^2 \Omega_1} R_1^2 R_2^2 (\Omega_1 - \Omega_2) \ln r
}.
\end{aligned}
\end{equation}
\end{subequations}
...
&\quad= -\frac{2 \pi R_1^2 \Delta z \mu}{R_2^2 - R_1^2} \lr{ R_2^2 \Omega_2 - R_1^2 \Omega_1 +\frac{R_1^2 R_2^2}{R_1^2} (\Omega_2 -\Omega_1) } \\
&\quad= \frac{2 \pi R_1^2 \Delta z \mu}{R_2^2 - R_1^2} \lr{ -2 R_2^2 \Omega_2 + (R_1^2 + R_2^2) \Omega_1 }.
\end{aligned}
\end{equation}
%
...
&= \frac{2 \pi R_2^2 \Delta z \mu}{R_2^2 - R_1^2} \lr{ R_2^2 \Omega_2 - R_1^2 \Omega_1 +\frac{R_1^2 R_2^2}{R_2^2} (\Omega_2 -\Omega_1) } \\
&= \frac{2 \pi R_2^2 \Delta z \mu}{R_2^2 - R_1^2} \lr{ -2 R_1^2 \Omega_1 + (R_1^2 + R_2^2) \Omega_2 }.
\end{aligned}
\end{equation}
%
%\unnumberedSubsection{Plotting the solutions}
Here are some plots of the velocities at different values for the outer cylinder angular velocity
\imageFourFiguresTwoLines
{../figures/phy454-continuumechanics/couetteFlowFig2}
{../figures/phy454-continuumechanics/couetteFlowFig3}
{../figures/phy454-continuumechanics/couetteFlowFig4}
{../figures/phy454-continuumechanics/couetteFlowFig5}
{Couette flow plots.}{fig:couetteFlow:couetteFlowFig2}{scale=0.3}
%
