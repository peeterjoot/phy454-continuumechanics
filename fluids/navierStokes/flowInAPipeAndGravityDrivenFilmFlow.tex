...
+ \frac{u_r u_\theta}{r}
\right) \\
&\quad+\zcap \left((\Bu \cdot \spacegrad) u_z\right).
\end{aligned}
\end{equation}
%
...
Referring to the Navier-Stokes equation \cref{eqn:continuumL12:570}, we see that our only surviving parts are
%
\begin{subequations}
...
\end{equation}
%
Our first Navier-Stokes equation \cref{eqn:classicalMechanicsPs2:590a} becomes
%
