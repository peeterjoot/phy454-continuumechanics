...
\end{equation}
%
These we called S-waves.  We also noted that the (transverse) compression waves (P-waves) with speed \(C_T = \sqrt{\mu/\rho}\), travelled faster than the (longitudinal) vorticity (S) waves with speed \(C_L = \sqrt{(\lambda + 2 \mu)/\rho}\) since \(\lambda > 0\) and \(\mu > 0\), and
%
