...
\end{equation}
%
Except for the antisymmetric term, note the structural similarity of \cref{eqn:strainProblems:110} and \cref{eqn:strainProblems:530}.  Why is it that we neglect the vorticity tensor in statics?
...
%\end{align*}
%
%This is easily seen to be the case, recovering \cref{eqn:strainProblems:90} by taking derivatives of \cref{eqn:strainProblems:110}, plus an assumption that \(e_{ij}\) is symmetric.
}
} % makeproblem.
...
\end{equation}
%
which for isotropic solids we model as
%
