...
\end{equation}
%
From \cref{eqn:revTextcontinuumL2:90} we see that we have
...
%
%\imageFigure{../figures/phy454-continuumechanics/continuumL6fig2}{continuumL6fig2.}{fig:continuumL6:continuumL6fig2}{0.2}
