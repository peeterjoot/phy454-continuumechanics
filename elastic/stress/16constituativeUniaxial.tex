...
%
Referring to \cref{fig:continuumL3:continuumL3fig4} and expanding out \cref{eqn:continuumL5:110c} we have for the \(1,1\) element of the strain tensor
...
\end{equation}
%
Note that we are still talking about uniaxial stress here.  Referring back to \cref{eqn:continuumL5:110c} we have
%
...
\end{equation}
%
Recall \cref{eqn:continuumL5:310} that we had
%
