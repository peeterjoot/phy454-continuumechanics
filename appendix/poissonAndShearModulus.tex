...
Young's modulus is given in \cref{eqn:continuumL5:330} (equation (43) in the Professor's notes) as
%
\begin{equation}\label{eqn:continuumL6:490}
E = \frac{\mu(3 \lambda + 2 \mu)}{\lambda + \mu },
\end{equation}
%
and for Poisson's ratio \cref{eqn:continuumL5:410} (equation (46) in the Professor's notes) we have
%
