...
\lr{ \PD{r}{u_r} } \\
&\quad+
2 r^2 d\theta^2 \lr{ \inv{r} \PD{\theta}{u_\theta} + u_r \inv{r} }
&\quad+ 2 r^2 \sin^2\theta d\phi^2 \lr{ \PD{\phi}{u_\phi} \inv{r \sin\theta} + \inv{r} u_r + \inv{r} \cot\theta u_\theta } \\
&\quad+2 dr r d\theta \lr{ \inv{r} \PD{\theta}{u_r} - \inv{r} u_\theta +\PD{r}{u_\theta} } \\
&\quad+2 r^2 \sin\theta d\theta d\phi \lr{ \PD{\phi}{u_\theta} \inv{r \sin\theta} - \inv{r} u_\phi \cot\theta +\inv{r} \PD{\theta}{u_\phi} } \\
&\quad+2 r \sin\theta d\phi dr \lr{ \inv{r \sin\theta} \PD{\phi}{u_r} - \inv{r} u_\phi + \PD{r}{u_\phi} }
.
\end{aligned}
\end{equation}
%
