...
&=
2 dr dr \PD{r}{u_r}
+ 2 r^2 d\phi d\phi \lr{ \inv{r} \PD{\phi}{u_\phi} +\inv{r} u_r }
+ 2 dz dz \PD{z}{u_z} \\
&\quad + 2 dz dr \lr{ \PD{z}{u_r} + \PD{r}{u_z} }
+ 2 dr r d\phi \lr{ \PD{r}{u_\phi} - \inv{r} u_\phi + \inv{r} \PD{\phi}{u_r} } \\
&\quad + 2 dz r d\phi \lr{ \PD{z}{u_\phi} +\inv{r} \PD{\phi}{u_z} }.
\end{aligned}
\end{equation}
%
...
(dr)^2 
\lr{
2 \frac{\partial u_r}{\partial r}+\left(\frac{\partial u_r}{\partial r}\right)^2+\left(\frac{\partial u_z}{\partial r}\right)^2+\left(\frac{\partial u_{\phi }}{\partial r}\right)^2
} \\
&\quad+(d\phi )^2 
\Biglr{
2 r u_r+u_r^2+u_{\phi }^2-2 u_{\phi } \frac{\partial u_r}{\partial \phi } \\
&\qquad+\left(\frac{\partial u_r}{\partial \phi }\right)^2+\left(\frac{\partial u_z}{\partial \phi }\right)^2+2 r \frac{\partial u_{\phi }}{\partial \phi }+2 u_r \frac{\partial u_{\phi }}{\partial \phi }+\left(\frac{\partial u_{\phi }}{\partial \phi }\right)^2
} \\
&\quad+(dz)^2 
\lr{
\left(\frac{\partial u_r}{\partial z}\right)^2+2 \frac{\partial u_z}{\partial z}+\left(\frac{\partial u_z}{\partial z}\right)^2+\left(\frac{\partial u_{\phi }}{\partial z}\right)^2
} \\
&\quad+dr d\phi  
\Biglr{
-2 u_{\phi }-2 u_{\phi } \frac{\partial u_r}{\partial r}+2 \frac{\partial u_r}{\partial \phi }+2 \frac{\partial u_r}{\partial r} \frac{\partial u_r}{\partial \phi }+2 \frac{\partial u_z}{\partial r} \frac{\partial u_z}{\partial \phi } \\
&\qquad +2 r \frac{\partial u_{\phi }}{\partial r}+2 u_r \frac{\partial u_{\phi }}{\partial r}+2 \frac{\partial u_{\phi }}{\partial r} \frac{\partial u_{\phi }}{\partial \phi }
} \\
&\quad+dz d\phi  
\Biglr{
-2 u_{\phi } \frac{\partial u_r}{\partial z}+2 \frac{\partial u_r}{\partial z} \frac{\partial u_r}{\partial \phi }+2 \frac{\partial u_z}{\partial \phi }+2 \frac{\partial u_z}{\partial z} \frac{\partial u_z}{\partial \phi } +2 r \frac{\partial u_{\phi }}{\partial z} \\
&\qquad +2 u_r \frac{\partial u_{\phi }}{\partial z}+2 \frac{\partial u_{\phi }}{\partial z} \frac{\partial u_{\phi }}{\partial \phi }
} \\
&\quad+dr dz 
\lr{
2 \frac{\partial u_r}{\partial z}+2 \frac{\partial u_r}{\partial r} \frac{\partial u_r}{\partial z}+2 \frac{\partial u_z}{\partial r}+2 \frac{\partial u_z}{\partial r} \frac{\partial u_z}{\partial z}+2 \frac{\partial u_{\phi }}{\partial r} \frac{\partial u_{\phi }}{\partial z}
}
.
\end{aligned}
\end{equation}
...
d\beta
\lr{
   \lr{ \PD{\alpha}{x^\mu} + \PD{\alpha}{u^\mu} } e_\mu
   +
   \lr{ x^\mu + u^\mu } \PD{\alpha}{e_\mu}
} \cdot \\
&\qquad 
\lr{
   \lr{ \PD{\beta}{x_\nu} + \PD{\beta}{u_\nu} } e^\nu
...
d\beta
\Biglr{
   \lr{ \PD{\alpha}{x^\mu} + \PD{\alpha}{u^\mu} } \lr{ \PD{\beta}{x_\mu} + \PD{\beta}{u_\mu} } \\
   &\quad+
   \lr{ x^\mu + u^\mu } \lr{ x_\nu + u_\nu } \PD{\alpha}{e_\mu}
   \cdot
   \PD{\beta}{e^\nu} \\
...
d\beta
\Biglr{
  \PD{\alpha}{u^\mu} \PD{\beta}{u_\mu}
  +
  2 \PD{\alpha}{u^\mu} \PD{\beta}{x_\mu}
  +
  \lr{ u^\mu u_\nu + x^\mu u_\nu + u^\mu x_\nu } \PD{\alpha}{e_\mu}
  \cdot
  \PD{\beta}{e^\nu} \\
...
d\alpha
\Biglr{
  \inv{2} \PD{\alpha}{u^\mu} \PD{\alpha}{u_\mu}
  +
  \PD{\alpha}{u^\mu} \PD{\alpha}{x_\mu}
  +
  \inv{2} \lr{ u^\mu u_\nu + x^\mu u_\nu + u^\mu x_\nu } \PD{\alpha}{e_\mu}
  \cdot
  \PD{\alpha}{e^\nu} \\
  &\qquad+
  \lr{ \PD{\alpha}{x^\mu} u_\nu + \PD{\alpha}{u^\mu}( x_\nu + u_\nu) } e_\mu \cdot \PD{\alpha}{e^\nu}
} \\
&\quad+
\sum_{\alpha < \beta}
2 d\alpha
...
\Biglr{
  \PD{\alpha}{u^\mu} \PD{\beta}{u_\mu}
  +
  \PD{\alpha}{u^\mu} \PD{\beta}{x_\mu}
  +
  \PD{\beta}{u^\mu} \PD{\alpha}{x_\mu} \\
  &\quad+
  \inv{2}
  \lr{ u^\mu u_\nu + x^\mu u_\nu + u^\mu x_\nu }
  \lr{
  \PD{\alpha}{e_\mu} \cdot \PD{\beta}{e^\nu} + \PD{\beta}{e_\mu} \cdot \PD{\alpha}{e^\nu}
  }
} \\
&\quad+
\sum_{\alpha < \beta}
...
\end{equation}
%
This essentially recovers the result \cref{eqn:continuumL2:190} derived in class.
%
...
\end{equation}
%
We are now set to evaluate the terms in the sum of \cref{eqn:continuumL2:610b} for the cylindrical coordinate system and should not need Mathematica to do it.  Let us do this one at a time, starting with all the squared differential pairs.  Those are, for \(\alpha \in \{r, \phi, z\}\) the value of
%
%
\begin{equation}\label{eqn:continuumL2:730}
\begin{aligned}
2 d\alpha d\alpha
\Biglr{
  &\inv{2} \PD{\alpha}{u_m} \PD{\alpha}{u_m}
  +
  \PD{\alpha}{u_m} \PD{\alpha}{x_m} \\
  &\quad+
  \inv{2} \lr{ u_m u_n + x_m u_n + u_m x_n }
  \PD{\alpha}{e_m}
  \cdot
  \PD{\alpha}{e_n} \\
  &\quad+
  \lr{ \PD{\alpha}{x_m} u_n + \PD{\alpha}{u_m}( x_n + u_n) }
  e_m \cdot
  \PD{\alpha}{e_n}
}
.
...
&2 d\phi d\phi
\Biglr{
  \inv{2} \PD{\phi}{u_m} \PD{\phi}{u_m}
  +
  \inv{2}
  \sum_{m = r, \phi}
  \lr{ u_m u_m + 2 x_m u_m } \\
  &\quad+
  \sum_{m n \in \{r \phi, \phi r\}}
  \lr{ \PD{\phi}{x_m} u_n + \PD{\phi}{u_m}( x_n + u_n) }
  e_m \cdot
  \PD{\phi}{e_n}
} \\
&=
...
\Biglr{
  \inv{2} \PD{\phi}{u_m} \PD{\phi}{u_m}
  + \inv{2} \lr{ u_r^2 + u_\phi^2 }
  + r u_r \\
  &\quad- \PD{\phi}{u_r} u_\phi
  + \PD{\phi}{u_\phi}( r + u_r)
}
.
\end{aligned}
...
\end{aligned}
\end{equation}
Now we have the two messy mixed terms.  For the \(r\), \(\phi\) term we get \( 2 dr d\phi \) times
%
\begin{equation*}
\begin{aligned}
&
...
\\
&+
  \lr{ \PD{r}{x_m} u_n + \PD{r}{u_m}( x_n + u_n) }
  e_m \cdot
  \PD{\phi}{e_n} \\
  &\quad+
  \lr{ \PD{\phi}{x_m} u_n + \PD{\phi}{u_m}( x_n + u_n) }
...
\end{equation*}
%
Finally for the \(z\), \(\phi\) term we have \( 2 dz d\phi \) times
%
%
\begin{equation*}
\begin{aligned}
&
  ...
  \inv{2} \lr{ u_m u_n + x_m u_n + u_m x_n }
  \lr{
    \cancel{\PD{z}{e_m}} \cdot \PD{\phi}{e_n}
    +
    \PD{\phi}{e_m} \cdot \cancel{\PD{z}{e_n} }
  }
\\
&+
  \lr{ \PD{z}{x_m} u_n + \PD{z}{u_m}( x_n + u_n) } e_m \cdot \PD{\phi}{e_n} \\
  &\quad+
  \lr{ \PD{\phi}{x_m} u_n + \PD{\phi}{u_m}( x_n + u_n) } e_m \cdot \cancel{\PD{z}{e_n}}
\\
&=
  \PD{z}{u_m}
  \PD{\phi}{u_m}
...
%
\begin{equation}\label{eqn:continuumL2:790}
\begin{aligned}
&{d\Bl'}^2 - d\Bx^2 \\
&=
2 dr dr
\lr{
  \inv{2} \PD{r}{u_m} \PD{r}{u_m} + \PD{r}{u_r}
} \\
&\quad+
2 r^2 d\phi d\phi
\Biglr{
   \inv{2 r^2} \PD{\phi}{u_m} \PD{\phi}{u_m}
   + \inv{2 r^2} \lr{ u_r^2 + u_\phi^2 } \\
   &\qquad+ \frac{u_r}{r}
   - \inv{r} \PD{\phi}{u_r} \frac{u_\phi}{r}
   + \inv{r} \PD{\phi}{u_\phi}\lr{ 1 + \frac{u_r}{r} }
} \\
&\quad+ 2 dz dz \lr{ \inv{2} \PD{z}{u_m} \PD{z}{u_m} + \PD{z}{u_z} } \\
&\quad +2 dr r d\phi
\lr{
  \PD{r}{u_m} \inv{r} \PD{\phi}{u_m}
  +
  \inv{r} \PD{\phi}{u_r}
  -
  \frac{u_\phi}{r}
  -
  \PD{r}{u_r} \frac{u_\phi}{r}
  +
  \PD{r}{u_\phi} \lr{ 1 + \frac{u_r}{r} }
} \\
&\quad+2 r d\phi dz
\lr{
  \PD{z}{u_m} \inv{r} \PD{\phi}{u_m}
  +
  \inv{r} \PD{\phi}{u_z}
  -
  \PD{z}{u_r} \frac{u_\phi}{r}
  +
  \PD{z}{u_\phi} \lr{ 1 + \frac{u_r}{r} }
} \\
&\quad+2 dz dr \lr{ \PD{z}{u_m} \PD{r}{u_m} + \PD{z}{u_r} + \PD{r}{u_z} }.
\end{aligned}
\end{equation}
%
...
%
\begin{equation}\label{eqn:continuumL2:890}
\begin{aligned}
&d{\Bl'}^2 - d\Bx^2 \\
&=
2 (dr)^2 
...
\Biglr{
  ...
  &\qquad+ \left(\inv{r} + \inv{r^2}u_r\right) \frac{\partial u_{\theta }}{\partial \theta }
  + \inv{2 r^2} \frac{\partial u_m}{\partial \theta } \frac{\partial u_m}{\partial \theta }
} \\
&\quad+ 2 r^2 \sin^2\theta (d\phi )^2 
\Biglr{
    \inv{2 r^2 \sin^2\theta} u_\phi^2
  + \inv{2 r^2 } u_{\theta }^2 \cot^2\theta
  + \inv{r} u_r
  + \inv{2 r^2} u_r^2 \\
  &\qquad + \left(\inv{r} + \inv{r^2}u_r\right) u_{\theta } \cot\theta 
...
\Biglr{
  ...
  &\qquad - \inv{r^2 } u_{\phi } \cot\theta \left(r + u_r + \frac{\partial u_{\theta }}{\partial \theta }\right) 
  + \inv{r^2 \sin\theta} \left(r + u_r \right) \frac{\partial u_{\theta }}{\partial \phi } \\
  &\qquad + \frac{\partial u_{\phi }}{\partial \theta } \left(\frac{u_{\theta }}{r^2} \cot\theta + \inv{r} + \frac{u_r}{r^2} \right)
  + \inv{r^2 \sin\theta} \frac{\partial u_m}{\partial \theta } \frac{\partial u_m}{\partial \phi }
} \\
&+ 2 r \sin\theta d\phi dr 
\Biglr{
  - \inv{r } u_{\phi }
  + \inv{r \sin\theta} \frac{\partial u_r}{\partial \phi }
  - u_{\phi } \inv{r } \frac{\partial u_r}{\partial r} \\
  &\qquad - u_{\phi } \cot\theta \inv{r } \frac{\partial u_{\theta }}{\partial r}
...
%
\begin{equation}\label{eqn:continuumL2:1110}
\begin{aligned}
(d\Bu + d\Bx)^2 - d\Bx^2
&=
\lr{ du_r - u_\theta d\theta - u_\phi \sin\theta d\phi + dr }^2 \\
&\quad +\lr{ du_\theta + u_r d\theta - u_\phi \cos\theta d\phi + r d\theta }^2 \\
&\quad +\lr{ du_\phi + u_r \sin\theta d\phi + u_\theta \cos\theta d\phi + r \sin\theta d\phi }^2.
\end{aligned}
\end{equation}
%
...
Collecting terms
%
\begin{equation}\label{eqn:continuumL2:1150}
\begin{aligned}
&\left((d\Bu + d\Bx)^2 - d\Bx^2\right) \\
&\quad=
2 dr^2 
\lr{ \PD{r}{u_r} } \\
&\qquad+ 2 r^2 d\theta^2 \lr{ \inv{r} \PD{\theta}{u_\theta} + u_r \inv{r} } \\
&\qquad+ 2 r^2 \sin^2\theta d\phi^2 \lr{ \PD{\phi}{u_\phi} \inv{r \sin\theta} + \inv{r} u_r + \inv{r} \cot\theta u_\theta } \\
&\qquad+2 dr r d\theta \lr{ \inv{r} \PD{\theta}{u_r} - \inv{r} u_\theta +\PD{r}{u_\theta} } \\
&\qquad+2 r^2 \sin\theta d\theta d\phi \lr{ \PD{\phi}{u_\theta} \inv{r \sin\theta} - \inv{r} u_\phi \cot\theta +\inv{r} \PD{\theta}{u_\phi} } \\
&\qquad+2 r \sin\theta d\phi dr \lr{ \inv{r \sin\theta} \PD{\phi}{u_r} - \inv{r} u_\phi + \PD{r}{u_\phi} }
.
\end{aligned}
\end{equation}
%
